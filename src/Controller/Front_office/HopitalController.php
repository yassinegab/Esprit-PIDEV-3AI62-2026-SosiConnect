...
class HopitalController extends AbstractController
{
    ...
    public function index(
        ...
        return $this->render('Front_office/hopital/index.html.twig', [
            ...
            'geo_count'    => count($hopitauxGeo), // conservé
            'pagination'   => $pagination,     // ✅ NOUVEAU — pour la pagination dans le template
        ]);
    }
     ...
     * INCHANGÉ
     */
 // src/Controller/Front_office/HopitalController.php
