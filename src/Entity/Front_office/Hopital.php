...
use Gedmo\Mapping\Annotation as Gedmo;                 // ✅ NOUVEAU — StofDoctrineExtensionsBundle
use Symfony\Component\HttpFoundation\File\File;
use Symfony\Component\Validator\Constraints as Assert;
use Vich\UploaderBundle\Mapping\Annotation as Vich;

// ✅ BUNDLE VichUploaderBundle — annotation obligatoire
#[Vich\Uploadable]
...
public function setType(?string $type): self
{
    ...
    // ====================================================
    // ✅ BUNDLE VichUploaderBundle — 3 champs (inchangés)
    // ====================================================
    ...
    // updatedAt — utilisé par VichUploader (pas Stof, pour éviter doublon)
    #[ORM\Column(nullable: true)]
    private ?\DateTimeImmutable $updatedAt = null;

    // ====================================================
    // ✅ BUNDLE StofDoctrineExtensionsBundle — 1 champ ajouté
    // updatedAt déjà géré par VichUploader — on ajoute seulement createdAt
    // ====================================================
    ...
    // ====================================================
    // ✅ BUNDLE VichUploaderBundle — getters/setters image (inchangés)
    // ====================================================
    ...
    // ✅ BUNDLE StofDoctrineExtensions — getter createdAt (pas de setter — géré automatiquement)
    ...
    public function isServiceUrgenceDispo(): ?bool { return $this->serviceUrgenceDispo; }
    public function setServiceUrgenceDispo(?bool $v): static { $this->serviceUrgenceDispo = $v; return $this; }
    ...
    public function setSpecialites(?string $specialites): static { $this->specialites = $specialites; return $this; }

    public function getSpecialitesArray(): array
    {
        if (empty($this->specialites)) return [];
    ...
    public function __toString(): string { return $this->nom ?? 'Hôpital'; }
}