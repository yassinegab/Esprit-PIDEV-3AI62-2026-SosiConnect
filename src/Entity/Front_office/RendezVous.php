...
use Gedmo\Mapping\Annotation as Gedmo;   // ✅ BUNDLE StofDoctrineExtensionsBundle
...
class RendezVous
{
    ...
    // ✅ BUNDLE StofDoctrineExtensionsBundle
    // Remplace : $this->createdAt = new \DateTimeImmutable() dans __construct()
    #[Gedmo\Timestampable(on: 'create')]
    #[ORM\Column(nullable: true)]
    private ?\DateTimeImmutable $createdAt = null;

    // ✅ BUNDLE StofDoctrineExtensionsBundle
    // Remplace : #[ORM\PreUpdate] public function preUpdate()
    ...
    {
        // ✅ Plus besoin de $this->createdAt = new \DateTimeImmutable()
        // Stof le fait automatiquement via #[Gedmo\Timestampable(on: 'create')]
        $this->statut = 'En attente';
    }

    // ✅ #[ORM\HasLifecycleCallbacks] et preUpdate() supprimés
    // Stof gère updatedAt automatiquement via #[Gedmo\Timestampable(on: 'update')]
    ...
    public function getHopital(): ?Hopital { return $this->hopital; }
    public function setHopital(?Hopital $hopital): static { $this->hopital = $hopital; return $this; }

    public function getTypeConsultation(): ?string { return $this->typeConsultation; }
    public function setTypeConsultation(?string $typeConsultation): static { $this->typeConsultation = $typeConsultation; return $this; }

    public function getStatut(): ?string { return $this->statut; }
    public function setStatut(?string $statut): static { $this->statut = $statut; return $this; }

    public function getScoreAI(): ?float { return $this->scoreAI; }
    public function setScoreAI(?float $scoreAI): static { $this->scoreAI = $scoreAI; return $this; }

    public function getDateRendezVous(): ?\DateTimeInterface { return $this->dateRendezVous; }
    public function setDateRendezVous(?\DateTimeInterface $dateRendezVous): static { $this->dateRendezVous = $dateRendezVous; return $this; }
