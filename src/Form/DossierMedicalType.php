...
class DossierMedicalType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        // OPTIONNEL : Champ médecin (commenté car pas dans l'entité DossierMedical actuelle)
        // → Si tu veux l'ajouter, ajoute d'abord la relation ManyToOne dans l'entité DossierMedical
        /*
