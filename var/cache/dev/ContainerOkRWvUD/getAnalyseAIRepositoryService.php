 ...
 */
class getAnalyseAIRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AnalyseAIRepository' shared autowired service.
     *
     * @return \App\Repository\AnalyseAIRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnalyseAIRepository.php';

        return $container->privates['App\\Repository\\AnalyseAIRepository'] = new \App\Repository\AnalyseAIRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
