 ...
 */
class getContactUrgenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContactUrgenceRepository' shared autowired service.
     *
     * @return \App\Repository\ContactUrgenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContactUrgenceRepository.php';

        return $container->privates['App\\Repository\\ContactUrgenceRepository'] = new \App\Repository\ContactUrgenceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
