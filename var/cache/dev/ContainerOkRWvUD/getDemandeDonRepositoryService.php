 ...
 */
class getDemandeDonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DemandeDonRepository' shared autowired service.
     *
     * @return \App\Repository\DemandeDonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DemandeDonRepository.php';

        return $container->privates['App\\Repository\\DemandeDonRepository'] = new \App\Repository\DemandeDonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
