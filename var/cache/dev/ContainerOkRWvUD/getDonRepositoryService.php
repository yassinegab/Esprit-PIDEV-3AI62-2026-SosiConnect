 ...
 */
class getDonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DonRepository' shared autowired service.
     *
     * @return \App\Repository\DonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DonRepository.php';

        return $container->privates['App\\Repository\\DonRepository'] = new \App\Repository\DonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
