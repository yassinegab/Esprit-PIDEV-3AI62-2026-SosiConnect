 ...
 */
class getLieuMedicalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LieuMedicalRepository' shared autowired service.
     *
     * @return \App\Repository\LieuMedicalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LieuMedicalRepository.php';

        return $container->privates['App\\Repository\\LieuMedicalRepository'] = new \App\Repository\LieuMedicalRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
