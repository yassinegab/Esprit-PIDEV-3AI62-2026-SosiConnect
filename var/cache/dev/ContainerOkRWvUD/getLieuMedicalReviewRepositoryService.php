 ...
 */
class getLieuMedicalReviewRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LieuMedicalReviewRepository' shared autowired service.
     *
     * @return \App\Repository\LieuMedicalReviewRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LieuMedicalReviewRepository.php';

        return $container->privates['App\\Repository\\LieuMedicalReviewRepository'] = new \App\Repository\LieuMedicalReviewRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
