 ...
 */
class getReponseDonRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReponseDonRepository' shared autowired service.
     *
     * @return \App\Repository\ReponseDonRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReponseDonRepository.php';

        return $container->privates['App\\Repository\\ReponseDonRepository'] = new \App\Repository\ReponseDonRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
