 ...
 */
class getSupportFeedbackRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SupportFeedbackRepository' shared autowired service.
     *
     * @return \App\Repository\SupportFeedbackRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SupportFeedbackRepository.php';

        return $container->privates['App\\Repository\\SupportFeedbackRepository'] = new \App\Repository\SupportFeedbackRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
