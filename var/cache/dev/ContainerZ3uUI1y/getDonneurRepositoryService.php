 ...
 */
class getDonneurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DonneurRepository' shared autowired service.
     *
     * @return \App\Repository\DonneurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DonneurRepository.php';

        return $container->privates['App\\Repository\\DonneurRepository'] = new \App\Repository\DonneurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
