 ...
 */
class getSupportTicketRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SupportTicketRepository' shared autowired service.
     *
     * @return \App\Repository\SupportTicketRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SupportTicketRepository.php';

        return $container->privates['App\\Repository\\SupportTicketRepository'] = new \App\Repository\SupportTicketRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
