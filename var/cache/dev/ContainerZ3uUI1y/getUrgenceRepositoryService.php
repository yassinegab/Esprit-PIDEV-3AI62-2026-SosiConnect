 ...
 */
class getUrgenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UrgenceRepository' shared autowired service.
     *
     * @return \App\Repository\UrgenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UrgenceRepository.php';

        return $container->privates['App\\Repository\\UrgenceRepository'] = new \App\Repository\UrgenceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
