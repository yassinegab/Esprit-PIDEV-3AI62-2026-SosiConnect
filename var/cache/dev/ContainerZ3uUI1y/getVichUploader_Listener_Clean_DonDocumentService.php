 ...
 */
class getVichUploader_Listener_Clean_DonDocumentService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.don_document' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.don_document'])) {
            return $container->privates['vich_uploader.listener.clean.don_document'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('don_document', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);

        if (isset($container->privates['vich_uploader.listener.clean.don_document'])) {
            return $container->privates['vich_uploader.listener.clean.don_document'];
        }

        return $container->privates['vich_uploader.listener.clean.don_document'] = $instance;
    }
}
