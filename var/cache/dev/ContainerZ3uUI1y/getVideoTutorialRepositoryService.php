 ...
 */
class getVideoTutorialRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VideoTutorialRepository' shared autowired service.
     *
     * @return \App\Repository\VideoTutorialRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VideoTutorialRepository.php';

        return $container->privates['App\\Repository\\VideoTutorialRepository'] = new \App\Repository\VideoTutorialRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
