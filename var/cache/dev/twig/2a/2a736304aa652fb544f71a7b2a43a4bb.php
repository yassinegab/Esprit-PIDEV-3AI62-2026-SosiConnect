...
class __TwigTemplate_808f049c1f32ec7be57fd91ac55ee000 extends Template
{
                        ...
                        if (CoreExtension::getAttribute($this->env, $this->source, $context["query"], "backtrace", [], "any", true, true, false, 275)) {
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                                ...
                                if (CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "file", [], "any", true, true, false, 291)) {
                                    // line 292
                                    yield "                                                                                    <a href=\"";
                                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->getFileLink(CoreExtension::getAttribute($this->env, $this->source, $context["trace"], "file", [], "any", false, false, false, 292), ($context["line_number"] ?? null)), "html", null, true);
                                    yield "\">
                                                                                ";
                                }
                                // line 294
...
";
    ...
    {
        return new Source("", "@Doctrine/Collector/db.html.twig", "C:\\Users\\Dhia\\Desktop\\nout\\wellness-connect-main\\vendor\\doctrine\\doctrine-bundle\\templates\\Collector\\db.html.twig");
    }
}
