...
class __TwigTemplate_31f888048ec6657f092c54540fbef14b extends Template
{
...
<?php if (\$logout_setup): ?>
    ";
        // line 12
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 12)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 13
            yield "        <div class=\"mb-3\">
            You are logged in as ";
            // line 14
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 14), "userIdentifier", [], "any", false, false, false, 14), "html", null, true);
            yield ", <a href=\"";
...
";
    ...
    {
        return new Source("", "@Maker/authenticator/login_form.tpl.php", "C:\\Users\\Dhia\\Desktop\\nout\\wellness-connect-main\\vendor\\symfony\\maker-bundle\\templates\\authenticator\\login_form.tpl.php");
    }
}
